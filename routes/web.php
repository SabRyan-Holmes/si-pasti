...
// Ketua Tim Pengajuan
Route::middleware(['auth', 'ketua_tim'])->prefix('ketua-tim')->name('ketua_tim.')->group(function () {
    ...
    // Riwayat Pengajuan
    Route::get('/riwayat-pengajuan/process', [KetuaTimController::class, 'riwayat_pengajuan'])->name('riwayat_pengajuan');
