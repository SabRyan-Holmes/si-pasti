                    ...
                    <table className="table table-zebra">
                        ...
                        <tbody>
                            ...
                            {pengajuan.map((data, i) => (
                                // <Link
                                //     as="tr"
                                //     className="group/item hover:bg-primary/50" href={route('ppk.show_pengajuan', data.kegiatan_id)}
                                // >
                                <tr>
                                    ...
                                    <Link as="td" href={route('ppk.show_pengajuan', data.kegiatan_id)} className="flex justify-center items-center gap-2 hover:bg-primary action-btn mt-2">
                                    <span>Lihat</span>
                                    <FaEye />
                                    </Link>
                                {/* </Link> */}
